...
![image](https://github.com/RENUGASARAVANAN/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/119292258/b060b58b-f2a4-4aac-94b3-28dcd19a385f)


## CIRCUIT DIAGRAM 

![image](https://github.com/RENUGASARAVANAN/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/119292258/2cf99e90-0c69-43be-bffe-7c12e0114589)
...
void lcd_display()
{
	...
	Lcd_cursor(&lcd,0,1);
	Lcd_string(&lcd,"Name:RENUGA S\n");

	Lcd_cursor(&lcd,1,1);
	Lcd_string(&lcd,"Reg no:212222230118\n");
	for(int x=0;x<100;x++)
	{
		Lcd_cursor(&lcd,2,1);
		Lcd_int(&lcd,x);
...
![image](https://github.com/RENUGASARAVANAN/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/119292258/d019163d-a83e-46a4-a314-c43a08db503e)

 
 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 

 ![image](https://github.com/RENUGASARAVANAN/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/119292258/9158a9f8-742a-40dc-808a-9b751ea139c8)
